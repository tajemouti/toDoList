...
/* harmony export */   barDone: () => (/* binding */ barDone),
...
var barDone = function barDone(e) {
  var clicked = e.target.closest('.checkbox');
  if (!clicked) return;
  var listNum = +clicked.dataset.btn;
  var taskList = document.querySelector(".task-".concat(listNum));
  ...
  var tasks = JSON.parse(localStorage.getItem('listItems')) || [];
  var taskDone = tasks.find(function (task) {
    return task.index === listNum;
  });
...
var clearDone = function clearDone() {
  ...
  var filtOrder = [];
  filtered.forEach(function (task, count) {
    task.index = count;
    filtOrder = [].concat(_toConsumableArray(filtOrder), [task]);
  });
...
var displayList = function displayList() {
  ...
  var sortedList = tasks.slice().sort(function (a, b) {
    return a.index - b.index;
  });
  taskList.innerHTML = '';
  sortedList.forEach(function (task) {
    var completed = task.completed;
    var checked = completed ? 'active' : '';
    var lineT = completed ? 'line' : '';
    var unfinished = !completed ? 'active' : '';
    var list = "\n        <div class=\"task task-".concat(task.index, "\">\n          <div class=\"checkbox\" data-btn=\"").concat(task.index, "\">\n            <button class=\"square ").concat(unfinished, "\"></button>\n            <button class=\"done ").concat(checked, "\"></button>\n          </div>\n          <input type=\"text\" class=\"list ").concat(lineT, "\" value=\"").concat(task.description, "\" data-desc=\"").concat(task.index, "\"/>\n          <button class=\"move\" data-remove=\"").concat(task.index, "\"></button>\n        </div>\n      ");
...
var addTask = function addTask(e) {
  ...
  var filtered = [].concat(_toConsumableArray(tasks), [task]);
  localStorage.setItem('listItems', JSON.stringify(filtered));
  displayList();
};
form.addEventListener('submit', addTask);
var removeTask = function removeTask(e) {
  var clicked = e.target.closest('.move');
  if (!clicked) return;
  var tasks = JSON.parse(localStorage.getItem('listItems')) || [];
  var listNum = +clicked.dataset.remove;
  var filtered = tasks.filter(function (task) {
    return task.index !== listNum;
  });
  var filtOrder = [];
...
var editTask = function editTask(e) {
  var clicked = e.target.closest('.list');
  if (!clicked) return;
  clicked.addEventListener('keyup', function () {
    var tasks = JSON.parse(localStorage.getItem('listItems')) || [];
    var listNum = +clicked.dataset.desc;
...
module.exports = __webpack_require__.p + "checked.png";
...
module.exports = __webpack_require__.p + "move.png";
...
/* harmony import */ var _cleardone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cleardone.js */ "./src/cleardone.js");



var taskList = document.getElementById('tasks');
taskList.addEventListener('click', _cleardone_js__WEBPACK_IMPORTED_MODULE_2__.barDone);
var clearBtn = document.getElementById('clear');
clearBtn.addEventListener('click', function () {
  (0,_cleardone_js__WEBPACK_IMPORTED_MODULE_2__.clearDone)();
  (0,_crud_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
(0,_crud_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
})();
